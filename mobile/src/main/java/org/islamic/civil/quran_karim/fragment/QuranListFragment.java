 ...
 * Use the {@link QuranListFragment#newInstance} factory method to
...
public class QuranListFragment extends Fragment
    ...
    public static QuranListFragment newInstance(int tabPosition) {
        QuranListFragment fragment = new QuranListFragment();
...
//        tv.setText("Text in Tab #" + tabPosition);
        ...
        mAdapter = new QuranListAdapter(getActivity(),mModels);
    ...
    void loadModelData(){
        mModels = QuranMetaDataHelper.getInstance(getActivity()).getSuraModel();
