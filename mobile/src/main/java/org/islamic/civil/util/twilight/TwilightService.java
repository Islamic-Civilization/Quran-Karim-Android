...
import org.islamic.civil.util.TwilightCalculator;
 ...
 */
public final class TwilightService extends Service {
...
//                    Slog.d(TAG, "Twilight state changed: " + state);
    ...
    private static boolean hasMoved(Location from, Location to) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1 &&
                to.getElapsedRealtimeNanos() < from.getElapsedRealtimeNanos()) {
            return false;
        }
